...
# ── Instruction FIFO — 32 entries per thread ─────────────────────────────
...
# ── MOP Expander — expands MOP instructions into long sequences ──────────
...
# ── Replay Expander — 32-slot replay buffer per thread ───────────────────
...
# ── Wait Gate — per-thread stall controller ──────────────────────────────
...
def _register_block_bits():
  ...
  for op in (0x45, 0x58, 0x5A, 0x60):                    # Scalar/ThCon (B5), also B0
...
# ── TensixThread — per-thread frontend pipeline ──────────────────────────
