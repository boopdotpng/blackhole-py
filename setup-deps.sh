...
case "$OS-$ARCH" in
  Darwin-arm64)
    URL="https://github.com/boopdotpng/blackhole-py/releases/download/v5/tt-metal-deps-darwin-arm64.tar.gz"
    ;;
  Linux-x86_64)
    URL="https://github.com/boopdotpng/blackhole-py/releases/download/v5/tt-metal-deps.tar.gz"
    ;;
  *)
