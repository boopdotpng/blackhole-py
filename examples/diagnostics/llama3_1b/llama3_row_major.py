...
from ttko.program import Buffer, Dram, Program
from ttko import DType
from ttko import l1
from ttko.cb import CB
from ttko.sfpu import LaneConfig, LReg, SfpuFormat, SfpuProgram
from ttko.sync import Sem, SemWait, Stall, Wait, sem_wait, stall
...
def allocate_kernel0_buffers(dram: Dram) -> Kernel0Buffers:
  ...
  options = {"global_address": True, "cores": K0_CORES, "tilized": False}
...
def main():
  ...
  parser.add_argument(
    "--safetensor", default="weights/llama3-1b/model.safetensors",
  )
