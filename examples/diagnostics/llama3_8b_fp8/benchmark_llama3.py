  ...
  try:
    for prompt_ids in prompts:
      ...
      results.append({
        ...
        "decode_us": samples,
        "weight_GB_s": rate * projection_bytes(runtime) / 1e9,
      })
...
def main():
  ...
  parser.add_argument("--reference", type=Path,
                      help="original examples/llama3_8b_fp8.py to compare on the same card")
