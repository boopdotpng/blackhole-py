...
Add an `microbenching/noc/riscv_dram_noc_bench.py` style harness:
...
The initial harness now lives in `microbenching/noc/riscv_dram_noc_bench.py`. It uses
...
Endpoint sweep modes in `microbenching/noc/riscv_dram_noc_bench.py`:
