...
The harness lives in `microbenching/noc/microbench_noc_mcast_mixed.py`.

## Goal

Measure NoC costs that are missing from `microbenching/models/program_timing_model.py`:
...
```sh
timeout 120s /home/boop/tenstorrent/.venv/bin/python3 microbenching/noc/microbench_noc_mcast_mixed.py --iters 4 --dests 3
```
...
```sh
/home/boop/tenstorrent/.venv/bin/python3 -m py_compile microbenching/noc/microbench_noc_mcast_mixed.py
/home/boop/tenstorrent/.venv/bin/python3 microbenching/noc/microbench_noc_mcast_mixed.py --help
```

Hardware commands run through the Tenstorrent device queue:

```sh
timeout 90s /home/boop/tenstorrent/.venv/bin/python3 microbenching/noc/microbench_noc_mcast_mixed.py --cases row --dests 1 --iters 1 --skip-mixed --no-report
timeout 120s /home/boop/tenstorrent/.venv/bin/python3 microbenching/noc/microbench_noc_mcast_mixed.py --iters 4 --dests 3
```
...
```sh
microbenching/noc/microbench_noc_mcast_mixed.py --iters 4 --dests 3
```
...
multicast rows. For `microbenching/models/program_timing_model.py`, charge multicast as
