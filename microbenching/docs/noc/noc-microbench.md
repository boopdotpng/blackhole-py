...
The harness lives in `microbenching/noc/riscv_noc_bench.py`.
...
```sh
PYTHONPATH=. TT_USB=1 /home/boop/tenstorrent/.venv/bin/python3 microbenching/noc/riscv_noc_bench.py --iters 1000
```
