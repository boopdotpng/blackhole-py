...
class RV32:
  def add(self, rd: R, rs1: R, rs2: R): return _r(0x33, 0, 0x00, rd, rs1, rs2)
  def sub(self, rd: R, rs1: R, rs2: R): return _r(0x33, 0, 0x20, rd, rs1, rs2)
  def mul(self, rd: R, rs1: R, rs2: R): return _r(0x33, 0, 0x01, rd, rs1, rs2)
  def divu(self, rd: R, rs1: R, rs2: R): return _r(0x33, 5, 0x01, rd, rs1, rs2)
  def remu(self, rd: R, rs1: R, rs2: R): return _r(0x33, 7, 0x01, rd, rs1, rs2)
  def sltu(self, rd: R, rs1: R, rs2: R): return _r(0x33, 3, 0x00, rd, rs1, rs2)
  def min(self, rd: R, rs1: R, rs2: R): return _r(0x33, 4, 0x05, rd, rs1, rs2)
  def and_(self, rd: R, rs1: R, rs2: R): return _r(0x33, 7, 0x00, rd, rs1, rs2)
  def or_(self, rd: R, rs1: R, rs2: R): return _r(0x33, 6, 0x00, rd, rs1, rs2)
  def xor(self, rd: R, rs1: R, rs2: R): return _r(0x33, 4, 0x00, rd, rs1, rs2)
  def addi(self, rd: R, rs1: R, imm: int): return _i(0x13, 0, rd, rs1, imm)
  def sltiu(self, rd: R, rs1: R, imm: int): return _i(0x13, 3, rd, rs1, imm)
  def andi(self, rd: R, rs1: R, imm: int): return _i(0x13, 7, rd, rs1, imm)
  def ori(self, rd: R, rs1: R, imm: int): return _i(0x13, 6, rd, rs1, imm)
  def xori(self, rd: R, rs1: R, imm: int): return _i(0x13, 4, rd, rs1, imm)
  def slli(self, rd: R, rs1: R, shamt: int): return _i(0x13, 1, rd, rs1, shamt)
  def srli(self, rd: R, rs1: R, shamt: int): return _i(0x13, 5, rd, rs1, shamt)
  def srai(self, rd: R, rs1: R, shamt: int): return _i(0x13, 5, rd, rs1, 0x400 | shamt)
  def lw(self, rd: R, rs1: R, offset: int = 0): return _i(0x03, 2, rd, rs1, offset)
  def lbu(self, rd: R, rs1: R, offset: int = 0): return _i(0x03, 4, rd, rs1, offset)
  def lhu(self, rd: R, rs1: R, offset: int = 0): return _i(0x03, 5, rd, rs1, offset)
  def sb(self, rs2: R, rs1: R, offset: int = 0): return _s(0x23, 0, rs1, rs2, offset)
  def sh(self, rs2: R, rs1: R, offset: int = 0): return _s(0x23, 1, rs1, rs2, offset)
  def sw(self, rs2: R, rs1: R, offset: int = 0): return _s(0x23, 2, rs1, rs2, offset)
  def beq(self, rs1: R, rs2: R, offset: int): return _b(0x63, 0, rs1, rs2, offset)
  def bne(self, rs1: R, rs2: R, offset: int): return _b(0x63, 1, rs1, rs2, offset)
  def blt(self, rs1: R, rs2: R, offset: int): return _b(0x63, 4, rs1, rs2, offset)
  def bge(self, rs1: R, rs2: R, offset: int): return _b(0x63, 5, rs1, rs2, offset)
  def bltu(self, rs1: R, rs2: R, offset: int): return _b(0x63, 6, rs1, rs2, offset)
  def bgeu(self, rs1: R, rs2: R, offset: int): return _b(0x63, 7, rs1, rs2, offset)
  def lui(self, rd: R, imm: int): return _u(0x37, rd, imm)
  def auipc(self, rd: R, imm: int): return _u(0x17, rd, imm)
  def jal(self, rd: R, offset: int): return _j(0x6F, rd, offset)
  def jalr(self, rd: R, rs1: R, offset: int = 0): return _i(0x67, 0, rd, rs1, offset)
  def csrrs(self, rd: R, rs1: R, csr: int): return _iu(0x73, 2, rd, rs1, csr)
  def csrrc(self, rd: R, rs1: R, csr: int): return _iu(0x73, 3, rd, rs1, csr)
  def fence(self): return _i(0x0F, 0, R.ZERO, R.ZERO, 0x0FF)
