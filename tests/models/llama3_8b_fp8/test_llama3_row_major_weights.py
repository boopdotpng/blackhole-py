...
from examples.llama3_8b_fp8 import Llama3Decode, _dense_byte_offset
...
class RowMajorWeightsTest(unittest.TestCase):
  ...
  def test_kernel0_weights_are_raw(self):
    from examples.diagnostics.llama3_8b_fp8.llama3_row_major import allocate_kernel0_buffers
