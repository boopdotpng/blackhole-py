...
# DMA service core: two 256 KiB upload buffers per engine. Download and
# generic-copy staging share only their own engine's first buffer.
DRAM_UPLOAD_BATCH_SIZE = 256 << 10
DRAM_BRISC_STAGING = 0x20000
DRAM_NCRISC_STAGING = DRAM_BRISC_STAGING + 2 * DRAM_UPLOAD_BATCH_SIZE
