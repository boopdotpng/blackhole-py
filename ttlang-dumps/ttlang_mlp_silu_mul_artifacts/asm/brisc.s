    ...
    sw	zero,-8(a5)
    auipc	a4,0x0
    addi	a4,a4,464 # 4ef4 <__kernel_data_lma>
    ...
    lui	t3,0xffb00
    lw	t2,0(a5)
    addi	t3,t3,1068 # ffb0042c <cb_interface>
    addi	a1,gp,-1960 # ffb00048 <dram_bank_to_noc_xy>
    lui	t5,0x2
    lui	t4,0x1
    lw	a2,80(t3)
    addi	t0,a1,8
    addi	a6,gp,-1492 # ffb0021c <bank_to_dram_offset>
    addi	t5,t5,146 # 2092 <.LASF1137+0x8>
    addi	t4,t4,-2048 # 800 <.LVUS175+0x3>
    lui	a4,0xffb30
    li	t6,1
    lhu	a3,14(a1)
    lw	a0,0(a6)
