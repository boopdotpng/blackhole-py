    ...
    addi	t1,t1,57 # 45002039 <__device_print_strings_info_end+0x3eb02039>
    lui	a7,0x45020
    sw	t1,0(a5)
    addi	a7,a7,58 # 4502003a <__device_print_strings_info_end+0x3eb2003a>
    lui	a6,0x45080
    sw	a7,0(a5)
    ...
    li	t5,256
    lui	a0,0x10
    addi	a0,a0,-1 # ffff <.LASF1645+0x3f1e>
    sw	t6,12(sp)
    sw	t5,112(a4)
    sw	a0,96(a4)
    sw	zero,80(a4)
    ...
    slli	a0,a4,0x8
    addi	t1,t1,-256 # ffff00 <.LASF1645+0xff3e1f>
    addi	t4,a2,24
    srli	a1,a4,0x10
    and	a0,a0,t1
    lui	a7,0x508c0
    ...
    sw	a4,0(a5)
    li	a2,1
    sw	a2,-2032(gp) # ffb00000 <_ZN7ckernel14dest_offset_idE>
    ttdmanop
    ttdmanop
    sh1add	a1,a1,a1
    lw	a4,68(a3)
