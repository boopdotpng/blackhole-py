    ...
    sw	zero,-8(a5)
    auipc	a4,0x0
    addi	a4,a4,668 # 63a4 <__kernel_data_lma>
    ...
    bne	a5,a3,61ac <.L11>
    lui	a6,0xffb40
    lw	a2,40(a6) # ffb40028 <__stack_base+0x3f3f8>
    lui	a4,0xffb00
    lbu	a7,-1971(gp) # ffb0003d <my_logical_x_>
    zext.h	a2,a2
    lbu	a0,-1972(gp) # ffb0003c <my_logical_y_>
    ...
    lui	a2,0x1
    sw	a5,-2040(a3)
    addi	a5,a2,-2048 # 800 <.LASF1230+0x1>
    sw	a5,-2016(a3)
    li	a5,1
    sw	a5,-1984(a3)
    lw	a3,0(a1)
    ...
    sw	a5,20(a4)
    lui	a6,0xffb41
    lw	a2,40(a6) # ffb41028 <__stack_base+0x403f8>
    zext.h	a2,a2
    fence
    lw	a3,32(a6)
    lw	a5,44(a4)
