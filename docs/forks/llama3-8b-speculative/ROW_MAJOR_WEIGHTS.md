...
Card 0: 514 teacher-forced predictions and 36 sampled logit/cache-recovery
checks matched ordinary decode exactly. Five 32-token generation workloads
also passed the existing verifier checks. See [report](validation/row-major-weights.json).
