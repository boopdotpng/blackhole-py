# Llama 3 8B FP8: fusion and instruction prefetch
...
Aggregate generation throughput: **48.09 tok/s**. Three prompts,
...
| Prompt | tok/s |
|---|---:|
| Explain why the sky is blue | 48.11 |
| Write a Python function that returns the Fibonacci sequence. | 48.08 |
| What are three interesting facts about the ocean? | 48.09 |
...
```json
{
  ...
  "examples/benchmark_llama3.py": "f76204f9279958847bd1bae90eaed2bbf93bd56d50e97e15667c7f51076f72b1"
}
```
