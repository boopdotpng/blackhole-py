...
The harness lives in `examples/microbench_math_backend.py`.
...
```sh
PYTHONPATH=. TT_USB=1 /home/boop/tenstorrent/.venv/bin/python3 examples/microbench_math_backend.py --iters 100
PYTHONPATH=. TT_USB=1 /home/boop/tenstorrent/.venv/bin/python3 examples/microbench_math_backend.py --iters 1 --tests empty,mop_tile_unthrottled
PYTHONPATH=. TT_USB=1 /home/boop/tenstorrent/.venv/bin/python3 examples/microbench_math_backend.py --iters 1 --tests empty,mop_tile_throttle0
```
...
For `examples/program_timing_model.py`, the most direct constant is:
...
- Command: `PYTHONPATH=. TT_USB=1 /home/boop/tenstorrent/.venv/bin/python3 examples/microbench_math_backend.py --iters 20`
- Core: logical `1,2`
...
- Command: `PYTHONPATH=. TT_USB=1 /home/boop/tenstorrent/.venv/bin/python3 examples/microbench_math_backend.py --iters 1 --tests empty,mop_tile_unthrottled`
- Core: logical `1,2`
...
- Command: `PYTHONPATH=. TT_USB=1 /home/boop/tenstorrent/.venv/bin/python3 examples/microbench_math_backend.py --iters 1 --tests empty,mop_tile_throttle0`
- Core: logical `1,2`
- Iterations per test: `1`
- Dispatch path: slow dispatch (`TT_USB=1`), one active TRISC1 role
- Drain marker: `PC_BUF_SYNC` plus `TTSTALLWAIT(SYNC, MATH|SFPU)` for math rows
